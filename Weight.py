"""A program that takes in a new weight in pound each week from human user and calculate the change from the previous input. Then plot a graph of the weight chaning trend with x-axis as week and y-axis as weight"""
...
#     ordered_weight_list=ordered_list(weight_week_list)
#     list_week=create_list(weight_dict)
#     graph(list_week,ordered_weight_list)
#     return
